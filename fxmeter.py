...
class MeterTemp(tk.Canvas):
    ...
    def graphics(self):
        ...
        for deg in range(-60,241,30):
            ...
            #rangex = self._stop - self._start
            #A la creation, le start et stop n'ont pas les bonnes valeurs.
            #val = ((deg + 240)*rangex/300 + self._start)/10
            #TODO: incliner le texte en fonction de l'angle gradué
            #self.createunit(deg, unit = str(int(val)), color = 'yellow')
